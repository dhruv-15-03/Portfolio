        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col lg={4} md={6} className="project-card">
            <ProjectCard
              ...
              approach="JVM-hosted, class-based language with Hindi-rooted English keywords (num/duo/sab/kya/ek/kaam). Three execution backends (AST · IR · bytecode), generics, multi-dim arrays, JSON diagnostics, an LSP server, an experimental EVM compiler target for smart contracts, and a from-scratch formal verifier (symbolic execution + Fourier"
